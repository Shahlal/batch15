...
<head>
  ...
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="../theme/backend/AdminLTE/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- Theme style -->
...
<div class="login-box">
  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="../index.php" class="h1"><b>SET</b>2020</a>
    </div>
    <div class="card-body">
...
<!-- jQuery -->
<script src="../theme/backend/AdminLTE/plugins/jquery/jquery.min.css"></script>
<!-- Bootstrap 4 -->
